...
const GlobalDashboard: React.FC<GlobalDashboardProps> = ({ data }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 p-4 sm:p-6 mb-6 sm:mb-8">
      <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 sm:mb-6 text-center font-inter">Global Inventory Dashboard</h2>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
        <div className="flex items-center space-x-3 sm:space-x-4">
          ...
          <div>
            ...
            <p className="text-lg sm:text-2xl font-bold text-fedshrim-purple font-inter">{totalItems}</p>
          </div>
        </div>
